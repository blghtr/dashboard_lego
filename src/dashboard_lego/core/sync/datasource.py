...
class DataSource:
    """
    Base data source with stateless 2-stage pipeline (synchronous only).
    ...
    SYNC ONLY - for async support, use AsyncDataSource instead.
    ...
    :complexity: 7
    :decision_cache: "Chose 2-stage over 3-stage for semantic clarity. Async methods removed - use AsyncDataSource for async support."
    """
