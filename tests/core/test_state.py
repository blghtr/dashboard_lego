...
class TestStateManager:
    ...
    def test_register_subscriber_auto_creates_dummy_state(
        self, state_manager: StateManager
    ):
        """
    ...
    def test_generate_callbacks_single_subscriber(
        self, state_manager: StateManager, mock_app
    ):
        """
        ...
        state_manager.register_subscriber(
            "test_state", "sub-id", "children", lambda x: x
        )
    ...
    def test_generate_callbacks_multiple_subscribers(
        ...
        state_manager.register_publisher("test_state", "pub-id", "value")
        state_manager.register_subscriber(
            "test_state", "sub-id-1", "children", lambda x: x
        )
        state_manager.register_subscriber(
            "test_state", "sub-id-2", "figure", lambda x: x
        )
